...
public record CreateScheduleRequest(
    ...
    @NotBlank(message = "일정 제목은 필수입니다") @Size(max = 100, message = "일정 제목은 최대 100자까지 입력 가능합니다") String name,

    @Schema(description = "메모/설명")
    String description,

    @Schema(description = "태그 목록", example = "[\"STUDY\", \"PROJECT\"]")
    @NotNull(message = "태그는 필수입니다") @Size(min = 1, message = "최소 1개 이상의 태그를 선택해야 합니다") Set<ScheduleTag> tags,

    @Schema(description = "시작 일시 (UTC ISO8601. 예: 2026-05-21T01:00:00Z)", example = "2026-05-21T01:00:00Z")
    @NotNull(message = "시작 일시는 필수입니다") Instant startsAt,

    @Schema(description = "종료 일시 (UTC ISO8601. 예: 2026-08-20T03:00:00Z)", example = "2026-08-20T03:00:00Z")
    @NotNull(message = "종료 일시는 필수입니다") Instant endsAt,
