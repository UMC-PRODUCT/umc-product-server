...
public record BatchResourcePermissionRequest(
    @NotEmpty(message = "queries는 최소 1개 이상이어야 합니다.") List<@NotNull(message = "query는 null일 수 없습니다.") @Valid ResourcePermissionQueryRequest> queries
) {
    ...
    public record ResourcePermissionQueryRequest(
        @NotNull(message = "resourceType은 필수입니다.") ResourceType resourceType,
        @Size(min = 1, message = "resourceIds는 비어 있을 수 없습니다.") List<@NotNull(message = "resourceIds는 null 값을 포함할 수 없습니다.") Long> resourceIds,
        @Size(min = 1, message = "permissionTypes는 비어 있을 수 없습니다.") List<@NotNull(message = "permissionTypes는 null 값을 포함할 수 없습니다.") PermissionType> permissionTypes
    ) {
