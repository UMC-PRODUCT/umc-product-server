...
class AuditCoveragePolicyTest {
    ...
    private static List<AuditSpec> auditedSpecs() {
        ...
        return List.of(
            ...
            spec("organization.application.service.UmcProductChapterCommandService", "create", "ORGANIZATION", "CREATE", "UmcProductChapter", type("organization.application.port.in.command.dto.CreateUmcProductChapterCommand")),
            spec("organization.application.service.UmcProductChapterCommandService", "update", "ORGANIZATION", "UPDATE", "UmcProductChapter", type("organization.application.port.in.command.dto.UpdateUmcProductChapterCommand")),
            spec("organization.application.service.UmcProductChapterCommandService", "delete", "ORGANIZATION", "DELETE", "UmcProductChapter", longType, longType),
            ...
            spec("organization.application.service.UmcProductMemberCommandService", "delete", "ORGANIZATION", "DELETE", "UmcProductMember", longType, longType),
            spec("organization.application.service.UmcProductMemberCommandService", "createActivityPeriod", "ORGANIZATION", "CREATE", "UmcProductMemberActivityPeriod", type("organization.application.port.in.command.dto.CreateUmcProductMemberActivityPeriodCommand")),
            spec("organization.application.service.UmcProductMemberCommandService", "updateActivityPeriod", "ORGANIZATION", "UPDATE", "UmcProductMemberActivityPeriod", type("organization.application.port.in.command.dto.UpdateUmcProductMemberActivityPeriodCommand")),
            spec("organization.application.service.UmcProductMemberCommandService", "deleteActivityPeriod", "ORGANIZATION", "DELETE", "UmcProductMemberActivityPeriod", longType, longType, longType),
            spec("organization.application.service.UmcProductMemberCommandService", "createChapterMembership", "ORGANIZATION", "CREATE", "UmcProductChapterMembership", type("organization.application.port.in.command.dto.CreateUmcProductChapterMembershipCommand")),
            spec("organization.application.service.UmcProductMemberCommandService", "updateChapterMembership", "ORGANIZATION", "UPDATE", "UmcProductChapterMembership", type("organization.application.port.in.command.dto.UpdateUmcProductChapterMembershipCommand")),
            spec("organization.application.service.UmcProductMemberCommandService", "deleteChapterMembership", "ORGANIZATION", "DELETE", "UmcProductChapterMembership", longType, longType, longType),
            spec("organization.application.service.UmcProductMemberCommandService", "createLeadership", "ORGANIZATION", "CREATE", "UmcProductLeadership", type("organization.application.port.in.command.dto.CreateUmcProductLeadershipCommand")),
            spec("organization.application.service.UmcProductMemberCommandService", "updateLeadership", "ORGANIZATION", "UPDATE", "UmcProductLeadership", type("organization.application.port.in.command.dto.UpdateUmcProductLeadershipCommand")),
            spec("organization.application.service.UmcProductMemberCommandService", "deleteLeadership", "ORGANIZATION", "DELETE", "UmcProductLeadership", longType, longType, longType),
            spec("organization.application.service.UmcProductSquadCommandService", "create", "ORGANIZATION", "CREATE", "UmcProductSquad", type("organization.application.port.in.command.dto.CreateUmcProductSquadCommand")),
            spec("organization.application.service.UmcProductSquadCommandService", "update", "ORGANIZATION", "UPDATE", "UmcProductSquad", type("organization.application.port.in.command.dto.UpdateUmcProductSquadCommand")),
            spec("organization.application.service.UmcProductSquadCommandService", "delete", "ORGANIZATION", "DELETE", "UmcProductSquad", longType, longType),
            spec("organization.application.service.UmcProductSquadCommandService", "createParticipant", "ORGANIZATION", "CREATE", "UmcProductSquadParticipant", type("organization.application.port.in.command.dto.CreateUmcProductSquadParticipantCommand")),
            spec("organization.application.service.UmcProductSquadCommandService", "updateParticipant", "ORGANIZATION", "UPDATE", "UmcProductSquadParticipant", type("organization.application.port.in.command.dto.UpdateUmcProductSquadParticipantCommand")),
