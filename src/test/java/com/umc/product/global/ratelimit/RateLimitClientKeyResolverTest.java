...
class RateLimitClientKeyResolverTest {
    ...
    @Test
    @DisplayName("인증 정보가 없으면 X-Forwarded-For 첫 IP 기준 key를 사용한다")
    void resolve_anonymous_ip_key_from_forwarded_for() {
        ...
        assertThat(clientKey.value()).isEqualTo("ip:203.0.113.7");
