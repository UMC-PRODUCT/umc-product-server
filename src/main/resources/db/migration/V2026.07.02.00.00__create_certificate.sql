...
(
    ...
    CONSTRAINT certificate_type_check CHECK (type IN ('COMPLETION', 'AWARD', 'PROJECT_PARTICIPATION')),
...
CREATE INDEX idx_certificate_scope_valid
    ON certificate (type, recipient_member_id, gisu_id, project_id, award_title, status, expires_at);
