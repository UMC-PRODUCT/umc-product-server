...
public record CreateUserFeedbackTemplateRequest(
    ...
    public CreateUserFeedbackTemplateCommand toCommand(Long requesterMemberId) {
        return CreateUserFeedbackTemplateCommand.builder()
