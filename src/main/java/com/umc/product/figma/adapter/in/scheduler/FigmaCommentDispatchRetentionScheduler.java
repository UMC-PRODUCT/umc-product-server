 ...
 * <p>
 * dispatch 테이블은 "이미 발송된 댓글" 의 가드 책임만 가지므로, 운영적으로 의미를 잃은 (보존 기간을 넘긴) 행을 주기적으로 삭제해 무한 누적을 막는다. 회수 주기는 {@code
 * app.figma.summary.retention-poll-interval} (기본 24시간) 으로, 보존 기간은 {@code app.figma.summary.dispatch-retention} (기본 90일) 로 설정한다.
 * <p>
