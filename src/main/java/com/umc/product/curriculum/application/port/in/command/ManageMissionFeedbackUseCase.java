...
public interface ManageMissionFeedbackUseCase {
     ...
     * 제출된 미션에 대한 피드백 작성
     * <p>
     * - 스터디 일정이 등록된 경우 일정 당일 00:00 이후에만 피드백 작성이 가능합니다. - N주차 워크북에 대한 피드백은 N+1주차 수요일 00:00 이전까지 제공되어야 합니다. - 선택 미션에 대한
     * 피드백은 기간이 경과되어도 불이익이 없습니다.
     *
     ...
     * 제출된 미션 피드백 수정
     * <p>
     * - 작성일 기준 2주가 경과되기 전까지만 수정 가능합니다. - PASS → FAIL 변경은 불가능합니다.
     *
