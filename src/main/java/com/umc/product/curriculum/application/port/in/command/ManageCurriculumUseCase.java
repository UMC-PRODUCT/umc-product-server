...
public interface ManageCurriculumUseCase {
     ...
     * @return 생성된 커리큘럼 ID
     */
    Long createCurriculum(CreateCurriculumCommand command);
     ...
     */
    void editCurriculum(EditCurriculumCommand command);
     ...
     */
    Long createWeeklyCurriculum(CreateWeeklyCurriculumCommand command);
     ...
     */
    void editWeeklyCurriculum(EditWeeklyCurriculumCommand command);
     ...
     */
    void deleteWeeklyCurriculum(Long weeklyCurriculumId);
}
