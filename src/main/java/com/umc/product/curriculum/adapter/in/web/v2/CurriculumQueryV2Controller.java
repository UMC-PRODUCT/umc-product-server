...
@Tag(name = "Curriculum V2 | 커리큘럼 Query", description = "커리큘럼 조회 V2")
public class CurriculumQueryV2Controller {
    ...
    @GetMapping("/original-workbook/{originalWorkbookId}")
    ...
    @GetMapping("/challenger-workbook/{challengerWorkbookId}")
    ...
    public PageResponse<BestWorkbookResponse> getBestWorkkbooks(
        @ParameterObject
