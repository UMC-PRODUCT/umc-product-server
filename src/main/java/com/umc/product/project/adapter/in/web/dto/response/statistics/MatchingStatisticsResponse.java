...
public record MatchingStatisticsResponse(
    ...
    @Schema(description = "학교 × 차수별 매칭 집계. schoolStat.total은 운영진만 제공(PM챌린저는 null).") List<SchoolStat> schoolStats,
    @Schema(description = "프로젝트 × 차수별 매칭 집계.") List<ProjectRoundStat> projectRoundStats
) {
