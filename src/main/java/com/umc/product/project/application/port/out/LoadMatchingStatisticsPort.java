...
public interface LoadMatchingStatisticsPort {
     ...
     */
    List<ProjectApplicantMatchingRoundInfo> getMembersByRound(Long gisuId, Long chapterId);

    /**
     * PM챌린저: ownerMemberId 소유 프로젝트(gisuId + chapterId 범위)의 ACTIVE ProjectMember 목록.
     */
    List<ProjectApplicantMatchingRoundInfo> getMembersByRoundForOwner(Long ownerMemberId, Long gisuId, Long chapterId);
}
