 ...
 * <p>
 * 사용자가 해당 기수의 챌린저가 아니거나 매칭 대상 파트가 아닌 경우(PLAN/ADMIN) 빈 리스트를 반환한다. 운영진 권한은 별도 {@code ChallengerRole} 로 표현되므로 본 결정에 영향을 주지
 * 않는다 — 운영진이면서 개발 파트 챌린저인 사용자도 본인 파트({@code WEB} 등) 기준으로 정상 조회된다.
 */
@Service
@RequiredArgsConstructor
@Transactional(readOnly = true)
public class ProjectApplicationQueryService implements GetMyProjectApplicationsUseCase {
