 ...
 * <p>
 * application property 의 {@code app.llm.provider=google-genai} 일 때만 활성화된다.
 * 인증은 Spring AI 의 google-genai 자동구성이 다음 두 경로 중 하나로 해결한다.
 * <ul>
...
public class SpringAiGoogleGenAiChatCompletionAdapter implements ChatCompletionPort {
    ...
    public ChatCompletionResult complete(ChatCompleteCommand command) {
        ...
        try {
            ...
            log.debug("Google GenAI 호출 성공: model={}, classification={}, length={}, promptTokens={}, completionTokens={}",
