...
public class NoticeQueryRepository {
    ...
    public Page<Notice> findByKeyword(
        ...
        BooleanExpression condition = buildClassificationConditionForKeywordSearch(classification, memberParts, target);
