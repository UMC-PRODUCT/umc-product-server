...
public interface AdminChapterControllerApi {
    ...
    @Operation(operationId = "CHAPTER-001", summary = "지부 생성", description = "새로운 지부를 생성합니다. 소속 학교를 함께 지정할 수 있습니다.")
    @ApiResponses(value = {
    ...
    @Operation(operationId = "CHAPTER-002", summary = "지부 일괄 생성")
    List<Long> createChapterBulk(@RequestBody List<CreateChapterRequest> requests);

    @Operation(operationId = "CHAPTER-003", summary = "지부 삭제", description = "지부를 삭제합니다. 소속 학교는 삭제되지 않습니다.")
    @ApiResponses(value = {
