...
public final class StudyGroupListResponse {
        ...
        public record Summary(
                ...
                public static Summary from(StudyGroupListInfo.StudyGroupInfo g) {
                        return new Summary(
                                        g.groupId(),
                                        g.name(),
                                        g.memberCount(),
                ...
                public static List<Summary> fromList(List<StudyGroupListInfo.StudyGroupInfo> list) {
        ...
        public record Leader(
                ...
                public static Leader from(StudyGroupListInfo.StudyGroupInfo.LeaderInfo leader) {
                        if (leader == null)
                                return null;
        ...
        public record Member(
                        ...
                        @Schema(description = "프로필 이미지 URL") String profileImageUrl) {
                public static Member from(StudyGroupListInfo.StudyGroupInfo.MemberSummaryInfo m) {
                        return new Member(m.challengerId(), m.name(), m.profileImageUrl());
                }

                public static List<Member> fromList(List<StudyGroupListInfo.StudyGroupInfo.MemberSummaryInfo> list) {
                        if (list == null)
                                return List.of();
