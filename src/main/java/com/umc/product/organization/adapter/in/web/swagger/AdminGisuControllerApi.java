...
public interface AdminGisuControllerApi {
    ...
    @Operation(summary = "[GISU-001] 기수 생성", description = "새로운 기수를 생성합니다.")
    @ApiResponses(value = {
    ...
    @Operation(summary = "[GISU-002] 기수 삭제", description = "기수를 삭제합니다. 연결된 지부 또는 학교가 있으면 삭제할 수 없습니다.")
    @ApiResponses(value = {
    ...
    @Operation(summary = "[GISU-003] 활성 기수 변경", description = "해당 기수를 활성 상태로 변경합니다. 기존 활성 기수는 비활성화됩니다.")
    @ApiResponses(value = {
