...
public class Post {
    ...
    public static Post createPost(String title, String content, Category category, String region, boolean anonymous) {
    ...
    public static Post createLightning(String title, String content, String region, boolean anonymous, LightningInfo info) {
        if (info == null) {
